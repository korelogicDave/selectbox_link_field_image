<?php
	require_once(EXTENSIONS.'/selectbox_link_field_image/views/view.php');
	...
	Class SBLPView_ImageGrid extends SBLPView
	{
		...
		public static function appendAssets(){
			if( self::$assets_loaded === false
				...
				$page->addStylesheetToHead(URL."/extensions/selectbox_link_field_image/assets/styles/view.imagegrid.css");
				$page->addScriptToHead(URL."/extensions/selectbox_link_field_image/assets/libraries/sblpview_imagegrid.js");
				$page->addScriptToHead(URL."/extensions/selectbox_link_field_image/assets/libraries/view.imagegrid.js");
			}
		}
	}
